...
class FiveStageCore(Core):
    def __init__(self, output_dir, imem, dmem):
        super(FiveStageCore, self).__init__(os.path.join(output_dir, "FS_"), imem, dmem)
        self.opFilePath = os.path.join(output_dir, "StateResult_FS.txt")
